...
public class BookingService {
    ...
    public List<InterviewSlot> getAllBookedSlots() {
        return slotRepository.findByStatus("BOOKED");
    }
    
    public List<InterviewSlot> getBookedSlotsByCandidate(Long candidateId) {
        return slotRepository.findByCandidateIdAndStatus(candidateId, "BOOKED");
    }
}